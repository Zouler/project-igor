...
var translations := {
	"en": {
		...
		"START_BUTTON_PLAY_WITH_IGOR": "Play with I.G.O.R.",
		"START_IGOR_GREETING": "Ready to build something wonderful?",
		...
		"IGOR_NAMEPLATE": "I.G.O.R.",
		"IGOR_REACT_HEAD": "Thinking gears activated!",
		"IGOR_REACT_ANTENNA": "Boing! Signal received.",
		"IGOR_REACT_CHEST": "I am I.G.O.R., your inventive guide.",
		"IGOR_REACT_BELLY": "Ha-ha! That tickles my bolts.",
		"IGOR_REACT_FEET": "Careful, my feet are vintage.",
		"IGOR_REACT_IDLE": "I wonder what we can build next.",
		"IGOR_REACT_SUCCESS": "You did it!",
		"IGOR_REACT_FAIL": "Interesting... let's try another shape.",
		"IGOR_PROTOTYPE_TEST_HINT": "Tap I.G.O.R.",

		"PLAY_IGOR_TITLE": "Play with I.G.O.R.",
		"PLAY_IGOR_HINT": "Tap I.G.O.R. and see what he does.",
		"PLAY_IGOR_BACK": "Back",
		"PLAY_IGOR_FUN_LABEL": "Fun",
		"PLAY_IGOR_FEELINGS_LABEL": "Feelings",
		"PLAY_IGOR_JOKE": "Joke",
		"PLAY_IGOR_SONG": "Song",
		"PLAY_IGOR_HAPPY": "Happy",
		"PLAY_IGOR_ENCOURAGE": "Encourage",
		"PLAY_IGOR_TOGGLE_DEBUG": "Touch zones",
		"IGOR_PLAY_JOKE_1": "Why did the gear smile? Because it finally found its teeth.",
		"IGOR_PLAY_JOKE_2": "I tried to count my bolts, but they kept rolling away.",
		"IGOR_PLAY_JOKE_3": "I once tried to dance, but my left foot filed a complaint.",
		"IGOR_PLAY_SONG_1": "Clink clank, little spark, building dreams from tiny parts.",
		"IGOR_PLAY_SONG_2": "Round and round the wheels will go, helping the planet grow.",
		"IGOR_PLAY_SONG_3": "Tiny parts and tiny sparks, building bridges, roads, and parks.",
		"IGOR_PLAY_HAPPY_1": "I like playing with you.",
		"IGOR_PLAY_HAPPY_2": "My circuits feel extra cheerful today.",
		"IGOR_PLAY_HAPPY_3": "Playing makes my old bolts feel brand new.",
		"IGOR_PLAY_ENCOURAGE_1": "Every strange idea can become a great invention.",
		"IGOR_PLAY_ENCOURAGE_2": "If it wobbles, we learn. If it works, we celebrate.",
		"IGOR_PLAY_ENCOURAGE_3": "A wobbly idea is still an idea.",
	...
	"es": {
		...
		"START_BUTTON_PLAY_WITH_IGOR": "Jugar con I.G.O.R.",
		"START_IGOR_GREETING": "¿Listo para construir algo maravilloso?",
		...
		"IGOR_NAMEPLATE": "I.G.O.R.",
		"IGOR_REACT_HEAD": "¡Engranajes de pensamiento activados!",
		"IGOR_REACT_ANTENNA": "¡Boing! Señal recibida.",
		"IGOR_REACT_CHEST": "Soy I.G.O.R., tu guía inventor.",
		"IGOR_REACT_BELLY": "¡Ja-ja! Eso hace cosquillas en mis tornillos.",
		"IGOR_REACT_FEET": "Cuidado, mis pies son antiguos.",
		"IGOR_REACT_IDLE": "Me pregunto qué podemos construir ahora.",
		"IGOR_REACT_SUCCESS": "¡Lo lograste!",
		"IGOR_REACT_FAIL": "Interesante... probemos otra forma.",
		"IGOR_PROTOTYPE_TEST_HINT": "Tocá a I.G.O.R.",

		"PLAY_IGOR_TITLE": "Jugar con I.G.O.R.",
		"PLAY_IGOR_HINT": "Tocá a I.G.O.R. y mirá qué hace.",
		"PLAY_IGOR_BACK": "Volver",
		"PLAY_IGOR_FUN_LABEL": "Diversión",
		"PLAY_IGOR_FEELINGS_LABEL": "Emociones",
		"PLAY_IGOR_JOKE": "Chiste",
		"PLAY_IGOR_SONG": "Canción",
		"PLAY_IGOR_HAPPY": "Feliz",
		"PLAY_IGOR_ENCOURAGE": "Ánimo",
		"PLAY_IGOR_TOGGLE_DEBUG": "Zonas táctiles",
		"IGOR_PLAY_JOKE_1": "¿Por qué sonrió el engranaje? Porque por fin encontró sus dientes.",
		"IGOR_PLAY_JOKE_2": "Intenté contar mis tornillos, pero se fueron rodando.",
		"IGOR_PLAY_JOKE_3": "Una vez intenté bailar, pero mi pie izquierdo se quejó.",
		"IGOR_PLAY_SONG_1": "Clink clank, pequeña chispa, sueños hechos con piezas.",
		"IGOR_PLAY_SONG_2": "Rueda, rueda sin parar, el planeta va a despertar.",
		"IGOR_PLAY_SONG_3": "Piezas pequeñas, chispas brillantes, construimos sueños gigantes.",
		"IGOR_PLAY_HAPPY_1": "Me gusta jugar con vos.",
		"IGOR_PLAY_HAPPY_2": "Mis circuitos están muy contentos hoy.",
		"IGOR_PLAY_HAPPY_3": "Jugar hace que mis tornillos viejos se sientan nuevos.",
		"IGOR_PLAY_ENCOURAGE_1": "Toda idea rara puede convertirse en un gran invento.",
		"IGOR_PLAY_ENCOURAGE_2": "Si se tambalea, aprendemos. Si funciona, festejamos.",
		"IGOR_PLAY_ENCOURAGE_3": "Una idea tambaleante sigue siendo una idea.",
